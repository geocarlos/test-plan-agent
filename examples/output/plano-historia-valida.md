...
- Confirmar regras específicas de permissão, mensagens, ordenação, filtros e limites de volume antes da automação.

## Critérios de aceite verificáveis
- Dado que o ator descrito na história tem permissão para executar a ação, quando solicita o comportamento 'Como cliente autenticado, quero consultar meus pedidos recentes para acompanhar a entrega.', então o sistema deve apresentar o resultado esperado de forma observável.
